...
### Added
- 新增 SKILL.md「1.2 描述项目的几条要求（写作口径）」：项目导向别写流程、正式书面不堆术语、
  不暴露个人/环境细节、不罗列堆砌文件/路径、外链不用 `**` 加粗包围。

## [1.4.0] - 2026-09-02

### Changed
- 简介写作要求由「用白话」改为「**正式、少技术细节**」：简介/一句话定位用正式书面语，
  说清「这是什么、解决什么问题」，别堆术语和技术细节。SKILL.md「1.1 简介/一句话定位」小节同步更新。

## [1.3.0] - 2026-09-02

### Added
- **简介用白话**：写 README 时简介/一句话定位尽量用大白话，少用术语、不用比喻，
  让不了解的人一眼看懂「这是什么、解决什么问题」。SKILL.md 新增「1.1 简介/一句话定位」小节。
